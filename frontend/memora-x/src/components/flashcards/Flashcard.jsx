  ...
  const [isFlipped, setIsFlipped] = useState(false);
    ...
    return <div className="relative w-full h-72" style={{ perspective: "1000px" }} >
      <div
        ...
        <div 
          className="absolute insert-0 w-full h-full bg-white-80 backdrop-blur-xl border-2 border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8 flex flex-col justify-between"
          style={{
          ...
          <button
            ...
            className={`w-9 h-9 rounded-xl flex items-center  transition-all duration-200 ${
              flashcard.isStarred
    ...
    <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
      ...
      <span>Click to reveal answer</span>
        ...
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-xl shadow-emeraqld-500/30 p-8 flex flex-col justify-between"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
